    ...
    class ListingController {
        ...
        public function destroy($params) {
            ...
            if(!Authorisation::isOwner($listing->user_id)) {
                Session::setFlashMessage('error_message', 'Your are not authorised to delete this listing');
        ...
        public function edit($params) {
            ...
            // Authorisation
            if(!Authorisation::isOwner($listing->user_id)) {
                Session::setFlashMessage('error_message', 'Your are not authorised to update this listing');
                return redirect('/listings/' . $listing->id);
            }
